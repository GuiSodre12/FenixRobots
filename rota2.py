...
autopilotagem(0, -33, 900)
autopilotagem(0, 5000000, 100000)
#autopilotagem(0, 53, 1000)
#autopilotagem(0, -3, 800)
#motorAnexoEsq.run_time(-9000, 450)
#autopilotagem(0, -6, 700)
#wait(1000)
#motorAnexoEsq.run_time(500, 1000)
